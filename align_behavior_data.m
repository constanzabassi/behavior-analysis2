function [aligned_imaging,imaging_array,align_info] = align_behavior_data (imaging,align_info,alignment_frames,left_padding,right_padding,data_type,alignment_type,varargin)
...
elseif strcmp(alignment_type ,'ITI')
...
elseif strcmp(alignment_type ,'all')
