...
[behav_param.p_val] = plot_performance(performance(:,chosen_mice),[params.info.savepath '/performance_analysis']);
plot_performance_all(performance(1,1:25),[],[params.info.mouseid{:}]);
