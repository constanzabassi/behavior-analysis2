function wrapper_SVM_cluster(current_mouse,save_string_glm,save_string_imaging,decoding_type,varargin)
...
if alignment.single_event == 1
    ...
    [output] = run_classifier_glm_inputs_cluster(current_mouse , save_string_glm,all_celltypes,mdl_param, alignment,info);
