...
function [acc] = run_classifier_glm_inputs_cluster_cross_time(current_mouse , save_string_glm,all_celltypes,mdl_param, alignment,info)
...
%             [~, condition_array] = divide_trials_updated (ex_imaging,{fieldss{mdl_param.field_to_predict}});
            ...
            output{splits,it,ce} = classify_over_time_glm_inputs_cross_time(mdl_X,mdl_Y, mdl_param,mdl_X_test,mdl_Y_test);
...
if mdl_param.field_to_predict == 1
    save_string = 'outcome_cross_time';
elseif mdl_param.field_to_predict == 2
    save_string = 'choice_cross_time';
elseif mdl_param.field_to_predict == 3
    save_string = 'sound_category_cross_time';
elseif mdl_param.field_to_predict == 4
    save_string = 'photostim_updated_cross_time';
end
