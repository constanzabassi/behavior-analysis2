function wrapper_SVM_cluster_all(current_mouse,save_string_glm,save_string_imaging,decoding_type,varargin)
...
if alignment.single_event == 1
    ...
    %use model that calculates it using either all pyr, all som, or all pv!
    [output] = run_classifier_glm_inputs_cluster_all_neurons(current_mouse , save_string_glm,all_celltypes,mdl_param, alignment,info);
