function wrapper_SVM_cluster_cross_time(current_mouse,save_string_glm,save_string_imaging,decoding_type,varargin)
%testing if a model trained at different timepoints can successfully
%predict the event being tested
...
if alignment.single_event == 1
    ...
    [output] = run_classifier_glm_inputs_cluster_cross_time(current_mouse , save_string_glm,all_celltypes,mdl_param, alignment,info);
