function wrapper_SVM_local_specific_batch(current_mouse,save_string_glm,save_string_imaging,decoding_type,varargin)
% wrapper code to run the SVM- this one will be getting specific neurons to
% run based on their information!
...
if alignment.single_event == 1
    ...
    [output,output_shuff, model_params] = run_classifier_glm_inputs_local_specified_cells(current_mouse , save_string_glm,all_celltypes,mdl_param, alignment,info);
